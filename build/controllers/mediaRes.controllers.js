...
exports.MediaResController = void 0;
...
class MediaRes {
    ...
    getMediaRes(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const producto = yield mediaRes_model_1.default.findById(id);
                if (!producto)
                    return response_1.respuesta.error(res, 400, 'El producto de media res no existe');
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const [productos, total] = yield Promise.all([
                    mediaRes_model_1.default.find(busqueda)
                        .or(filtroOR)
                        .sort([ordenar]),
                    mediaRes_model_1.default.find(busqueda)
                        .or(filtroOR)
    ...
    actualizarMediaRes(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const productos = req.body;
                productos.forEach((producto) => __awaiter(this, void 0, void 0, function* () {
                    yield mediaRes_model_1.default.findByIdAndUpdate(producto._id, { cantidad: producto.cantidad }, { new: true });
                }));
...
exports.MediaResController = new MediaRes();
