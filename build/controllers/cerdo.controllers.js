...
exports.CerdoController = void 0;
...
class Cerdo {
    ...
    getCerdo(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const producto = yield cerdo_model_1.default.findById(id);
                if (!producto)
                    return response_1.respuesta.error(res, 400, 'El producto de cerdo no existe');
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const [productos, total] = yield Promise.all([
                    cerdo_model_1.default.find(busqueda)
                        .or(filtroOR)
                        .sort([ordenar]),
                    cerdo_model_1.default.find(busqueda)
                        .or(filtroOR)
    ...
    actualizarCerdo(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const productos = req.body;
                productos.forEach((producto) => __awaiter(this, void 0, void 0, function* () {
                    yield cerdo_model_1.default.findByIdAndUpdate(producto._id, { cantidad: producto.cantidad }, { new: true });
                }));
...
exports.CerdoController = new Cerdo();
